...
const RecipeTemplate = ({data}) => {
  const { title, cookTime, prepTime, content, servings, image, description:{description}}= data.contentfulRecipe
        ...
        <main className="page">
          <div className="recipe-page">
            ...
            <section className="recipe-hero">
              <GatsbyImage image= {imagePath} alt= {title} className=" about-img"></GatsbyImage>
